...
## Overview
This is our submission for the DEVTRAILS hackathon conducted by Guidewire. We aim to predict 6 issues that are faced in k8 clusters. We used different algorithms like LighGMB and Random forest but XGBoost had the highest accuracy.
